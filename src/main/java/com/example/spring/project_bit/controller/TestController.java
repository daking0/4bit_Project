...
public class TestController {
    ...
    public void applyTest(String userId, String testId){
        // 실제 학생이 시험보는 페이지
    }

    // 3-2-1(read)-1(submit)-s
    @RequestMapping("/class/test?testno={testno}/apply")
    public void submitTest(String userId, String testId){
        // 시험 다 푼 다음 제출버는 누르는 순간 동작하는 메서드(?)
    }

    // 3-2-1(read)-1(submit)-s
    @RequestMapping("/class/test?testno={testno}/apply")
    public void reviewTest(String userId, String testId){
    ...
    public void readNowTest(String userId, String testId){
        // 현재 진행중인 시험 상세 페이지 표시
        // 유저가 학생이냐 강사냐에 따라 수정/삭제버튼 표시
    }

    @RequestMapping("/class/test?testId={testId}/edit")
    public void editNowTest(String userId, String testId){
        // 현재 진행중인 시험 상세 페이지 수정(강사ONLY)

    }

    @RequestMapping("/class/test?testId={testId}")
    public void deleteNowTest(String userId, String testId){
...
//    }
    ...
    public void readEndedTest(String userId, String testId){
        // 종료된 시험 상세 페이지 표시

    }

    @RequestMapping("/study/endedtest?testId={testId}/edit")
    public void editEndedTest(String userId, String testId){
    ...
    @RequestMapping("/study/endedtest?testId={testId}")
    public void deleteEndedTest(String userId, String testId){
    ...
    public void readEndedTestResult(String userId, String testId){
